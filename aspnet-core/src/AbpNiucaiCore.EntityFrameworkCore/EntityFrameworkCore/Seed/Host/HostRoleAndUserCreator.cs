...
namespace AbpNiucaiCore.EntityFrameworkCore.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        private readonly AbpNiucaiCoreDbContext _context;

        public HostRoleAndUserCreator(AbpNiucaiCoreDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            if (adminUserForHost == null)
            {
                ...
                var permissions = PermissionFinder
                    .GetAllPermissions(new AbpNiucaiCoreAuthorizationProvider())
